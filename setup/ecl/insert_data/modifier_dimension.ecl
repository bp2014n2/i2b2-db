...
OUTPUT(modDim,,'~i2b2demodata::modifier_dimension12345678',OVERWRITE);
SEQUENTIAL(STD.File.StartSuperFileTransaction(),
STD.File.AddSuperFile('~i2b2demodata::modifier_dimension','~i2b2demodata::modifier_dimension12345678'),
