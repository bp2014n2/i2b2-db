...
observation_fact_idx_inverted_provider_id_all := INDEX(observation_fact, {provider_id}, {modifier_cd,valtype_cd,tval_char,start_date,patient_num}, '~i2b2demodata::observation_fact_idx_inverted_provider_id_all');
BUILD(observation_fact_idx_inverted_provider_id_all, SORT ALL, OVERWRITE);