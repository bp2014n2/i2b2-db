...
observation_fact_idx_inverted_provider_id := INDEX(observation_fact, {concept_cd,provider_id,start_date,patient_num}, {modifier_cd, tval_char, valtype_cd}, '~i2b2demodata::observation_fact_idx_concept_cd_provider_id');
