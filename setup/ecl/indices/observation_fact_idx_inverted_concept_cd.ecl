...
observation_fact_idx_inverted_concept_cd := INDEX(observation_fact, {concept_cd}, {modifier_cd,valtype_cd,tval_char,start_date,patient_num}, '~i2b2demodata::observation_fact_idx_inverted_concept_cd');
